...
namespace Brash\Framework\Data\Migrations;
...
final class Version20230510120934 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(sprintf('INSERT into accounts (%s) VALUES (:id,:email,:username,:password,:role,:uuid,:created_at,:updated_at)', $fields), $values);
    }
